          ...
          <Col md={6} className="row">
            <main id="main_repository-page">
              <header id="header_repository-page">
                ...
                <div className="repository_link-buttons">
              ...
              <div className="repository-section">
                <header className="repository-section-header">
                  <h4>How to access?</h4>
                </header>
                <div className="repository-section-content">
                  <div className="git-way-access-div">
                    <h5 className="git-way-access-title">Clone with HTTPS:</h5>
                    <span className="git-way-access">
                      {repository.clone_url}
                    </span>
                  </div>
                  <div className="git-way-access-div">
                    <h5 className="git-way-access-title">Clone with SSH:</h5>
                    <span className="git-way-access">
                      {repository.ssh_url}
                    </span>
                  </div>
